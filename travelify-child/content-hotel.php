    ...
    <?php do_action( 'travelify_before_post_meta' ); ?>
      ...
      <div class="entry-content clearfix">
        ...
        <div class="element-data-wrapper">
            <table>
            <tr>
              <td><?php the_field('hotel_address');?></td>
            </tr>
            <tr>
              <td><a href="<?php the_field('hotel_website');?>">Website</a></td>
            </tr>
            <tr>
              <td><a href="<?php the_field('general_reviews');?>">Yelp Reviews</a></td>
            </tr>
          </table>
        ...
        <div>
          ...
          <br />
          <?php echo do_shortcode('[cbxmcratingreview_postreviews  form_id="4"]'); ?>
          <br />
